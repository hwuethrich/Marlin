...
// Anycubic Delta
#define DEFAULT_Kp 32.42
#define DEFAULT_Ki 3.60
#define DEFAULT_Kd 73.04
...
#define DELTA
  ...
  #define DELTA_HEIGHT 295.70 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.60, 0.0, -0.29 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 134.70 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.84, -0.34, 0.00 } // get these values from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 160, 100 }  // default steps per unit for Kossel (GT2, 20 tooth)
